Cat Jump é um jogo 2D feito em C++ usando a biblioteca [raylib](https://www.raylib.com/). Controle o gato para pular,comer os pombos e se movimentar enquanto o tempo passa. 
